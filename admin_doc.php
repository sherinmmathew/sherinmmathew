	   ...
	   <div class="mother-grid-inner">
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile "style="width:800px">
								<h1>EaseDok.com</h1>
							</div>
...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item">Home <i class="fa fa-angle-right"></i>Doctors</li>
            </ol>
                        <?php
						//session_start(); 
						include("connect.php");
						$qry="select * from user_login join user_details where user_login.login_id= user_details.login_id and user_login.user_type_id='2'";
						$res=mysql_query($qry);
						$i=1;
							...
							{ ?>
								<tr>
                                    ...
                                    <td> <?php if($row['user_status']==1){
                                        ...
                                        <?php } ?>
                                        	<span class="badge badge-primary"><a href="doc_status_update.php?id=<?php echo $row['user_details_id']; ?>&&sts=<?php echo $row['user_status']; ?>" style="color:#FFFFFF">Update Status</a> 
