...
<!--heder end here-->
		<ol class="breadcrumb">
              <font color="Blue">Home </font>> <font color="red">View Appointments</font>
            </ol>
	<?php
				//session_start(); 
				 include("connect.php");
...
//echo $u_id;
			...
			$qry="select * from  appointment where user_details_id ='$u_id'";
						$res=mysql_query($qry);
						$i=1;
						  //echo $log_id;
							...
							{ ?>
								<tr>
                                    ...
                                    <td> <?php echo $row['time']; ?></td>
                                        ...
                                        <?php } ?></td>
                      <td><span class="badge badge-primary"><a href="cancel.php?id=<?php echo $row['appointment_id']; ?>" style="color:#FFFFFF">Cancel</a> 
