...
<?php
					   ...
					   $user_id=$result['user_details_id'];
					   ?>
										...
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">
												...
												<div class="user-name">
													...
													<P><span><b><?php echo $u_name=$result['user_full_name']; ?></b></span></p>
...
<form action="scheduling_process.php"method="post">
<h3>Morning Section</h3> <br>
Start Time:&nbsp
<input type="text" name="start_time">&nbsp
End Time:&nbsp
...
<div class="copyrights">
	 <p>© 2018 EaseDok.com. All Rights Reserved | Design by  <a href="#" target="_blank">CR7</a> </p>
</div>	
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li ><a href="Add_scheduling.php"><i class="fa fa-tachometer"></i>Morning Section
										<li ><a href="Evening.php"><i class="fa fa-tachometer"></i>Evening Section
