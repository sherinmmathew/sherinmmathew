...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../doctor/index.html">Home</a> <i class="fa fa-angle-right"></i></li>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<!--<li ><a href="Add_scheduling.php"><i class="fa fa-tachometer"></i>Sheduling-->
